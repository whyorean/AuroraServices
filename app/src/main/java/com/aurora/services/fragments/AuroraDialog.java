package com.aurora.services.fragments;
...
public class AuroraDialog extends AppCompatDialog {
    ...
    private View wrap(View view) {
        ...
        frameLayout.setBackground(new ColorDrawable(ResourcesCompat.getColor(resources, R.color.colorScrim, context.getTheme())));
        return frameLayout;
    }
}
